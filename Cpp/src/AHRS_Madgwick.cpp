...
//====================================Public Members==========================================//
//--------------------------Compute---------------------------//
void AHRS_Madgwick::compute(float g_x, float g_y, float g_z, float a_x, float a_y, float a_z, float m_x, float m_y,
                            float m_z, float loop_time_s) {
    ...
    SEq_3SEq_3 = q3 * q3;
    SEq_4SEq_4 = q4 * q4;
    h_x = twom_x * (0.5f - SEq_3SEq_3 - SEq_4SEq_4) + twom_y * (SEq_2SEq_3 - SEq_1SEq_4)
          + twom_z * (SEq_2SEq_4 + SEq_1SEq_3);
    h_y = twom_x * (SEq_2SEq_3 + SEq_1SEq_4) + twom_y * (0.5f - SEq_2SEq_2 - SEq_4SEq_4)
    ...
    Pitch = atan2f((2.f * (SEq_3SEq_4 + SEq_1SEq_2)), (SEq_1SEq_1 - SEq_2SEq_2 - SEq_3SEq_3 + SEq_4SEq_4));
    Roll = -asinf((2.f * (SEq_2SEq_4 - SEq_1SEq_3)));
